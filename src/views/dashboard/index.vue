...
<template>
  <a-row type="flex" justify="space-between" align="top" class="dashboard">
    <a-col :span="6" class="item-box">
      ...
      <div class="box">
        ...
        <div class="pending-box">
          <div v-for="(item,i) in riskData" :key="i" class="list" :style="{backgroundColor:item.bgColor}">
    ...
    <a-col :span="12" class="item-box">
      ...
      <!-- 地图 -->
      <div class="map" style="height:300px;background-color: #fff;">
        map
      </div>
    </a-col>
    <a-col :span="6" class="item-box">
      ...
      <div class="fast">
        <template v-for="(item,i) in fastData" :key="i" >
          <div class="item" v-if="i<4" :style="{background:item.bgColor}">
