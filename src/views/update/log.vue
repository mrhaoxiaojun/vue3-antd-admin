<template>
  <div class="log__container">
    <div class="title">2021年04月27日</div>
    <ul>
      <li>antd按需加载引入</li>
    </ul>
    <div class="title">2021年04月20日</div>
    <ul>
      <li>axios和拦截器配置修改、提取api集中管理</li>
      <li>添加页面加载进度条管理</li>
      <li>国际化引入，及配置</li>
      <li>更改正常显示需依赖外部api接口为本地mock数据</li>
      <li>添加hooks-useMapState</li>
    </ul>
    <div class="title">2021年04月04日</div>
    <ul>
      <li>layout布局配置化（side、head、mix）</li>
      <li>layout sidebar折叠配置化、多页签配置化</li>
      <li>国际化引入，及配置</li>
